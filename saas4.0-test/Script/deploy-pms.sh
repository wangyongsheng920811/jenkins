...
cp $WORKSPACE/code/qypms-boot.jar ./
mv logs/log.log logs/log.logbak
echo "开始启动..."
nohup /usr/local/jdk1.8.0_201/bin/java -jar qypms-boot.jar --spring.profiles.active=test >>logs/log.log 2>&1 &
n=1
while true
do
